...
const REPORT_DEFINITIONS = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'topSpeed', label: 'Top speed (kph)', dataType: 'number' },
      { key: 'topSpeedAddress', label: 'Top speed location', dataType: 'text' },
      { key: 'latestSpeed', label: 'Latest alert speed (kph)', dataType: 'number' },
      { key: 'latestLocation', label: 'Latest alert location', dataType: 'text' },
